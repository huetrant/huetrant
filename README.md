...
![SQLModel](https://img.shields.io/badge/SQLModel-4B8BBE?style=flat)
...
- Building end-to-end web applications with FastAPI + React/Next.js
- REST API design and implementation
- Database modeling with PostgreSQL and SQLModel
...
- Data processing and pipeline workflows
...
*Computer Science Student | GPA: 3.66/4.0*
